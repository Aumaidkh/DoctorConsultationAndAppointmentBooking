...
import com.android.doctorce.feature_book_appointment.presentation.ui.appointment.AppointmentActivity
...
class SearchDoctorActivity : AppCompatActivity() {
    ...
    private fun onDoctorClicked(doctor: DoctorModel){
        val doctorDescriptionIntent = Intent(this, AppointmentActivity::class.java)
